...
def analyze_with_ai(text):
    ...
    system_instructions = (
        ...
        "- إذا كانت الرسالة سؤال عن مبلغ سابق مثل: \"كم صرفت على العلف هذا الشهر؟\" → mode = \"query\" و query_mode = true و should_save = false.\n"
        "- إذا كانت الرسالة عن بيع أو شراء حيوانات (غنم، أبقار، ثور، …) فحدد أيضاً:\n"
        "  livestock_change_mode = true ، واملأ livestock_animal_type و livestock_breed و livestock_delta.\n"
        "  مثال: \"تم بيع غنم اضاحي 2 ب 1500\" → livestock_animal_type = \"غنم\" ، livestock_breed = \"اضاحي\" ، livestock_delta = -2.\n"
        "- إذا لم تكن الرسالة متعلقة بالمال إطلاقاً → mode = \"other\" و should_save = false و query_mode = false و livestock_change_mode = false.\n"
